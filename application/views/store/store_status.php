                ...
                <tbody >
                    ...
                    <?php foreach ($str_list as $strlist): ?>
                        <tr>
                            ...
                            <?='<td><a href="' . site_url('store/itemdetails').'/' . $strlist['str_ast_id'] . '" data-toggle="tooltip" data-placement="top" title="View Details of '. $strlist['ast_name'] .'" class="Edit_vandor" id="' . $strlist['str_ast_id'] . '" target="_blank"><img width="20px"  src="' . site_url('resource/img/view.png') . '" alt="View"></a></td>';?>
                        </tr>
                    <?php endforeach; ?>
                </tbody >
            </table>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("body").on("change", "#category", function () {
            ...
            $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>store/get_srote_status_info",
            data: {at_id: $(this).val()},
            beforeSend: function () {

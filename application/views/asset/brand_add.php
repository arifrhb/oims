...
<div id="div-forms">    
    ...
    <div class="col-sm-5">
        ...
        <form id="login-form" action="<?=site_url('assets/brand') ?>" method="post" class="form-horizontal">
        
            <div class="modal-body">

                <select id="ast_at_id" class="form-control" autofocus>
                ...
                <input id="bnd_name" name="bnd_name" type="text" class="form-control" placeholder="Brand Name" required="required" class="form-control">
